...
st.markdown("""
    ...
    /* Keep header/footer managed cleanly so sidebar toggle is never lost */
    ...
    [data-testid="stSidebar"] {
        ...
        border-right: 2px solid rgba(0, 229, 255, 0.2) !important;
...
# ==========================================
    ...
    fig2.add_hline(y=T_inf, line_dash="dash", line_color="#00E5FF", annotation_text="Ambient Equilibrium", annotation_font_color="#00E5FF")
